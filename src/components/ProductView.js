...
import { Card, ListGroup, ListGroupItem,Container,Row, Col,Image } from 'react-bootstrap';
            ...
            <Container fluid className="mt-5">
                <Row>
                    ...
                    <Col className="col-sm product-desc" lg={4}>
                             <h4>{selectedProduct.name}</h4><p></p>
                             <h6>{selectedProduct.discount}</h6>
                             <p>{selectedProduct.shipping > 125 &&  <span>FREE GROUND SHIPPING on all orders over 125</span> }</p>
